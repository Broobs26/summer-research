...
#ifndef TENSORFLOW_LITE_MODEL_CHUNK2_H_
#define TENSORFLOW_LITE_MODEL_CHUNK2_H_
...
extern const unsigned char model_chunk2[];
extern const int model_chunk2_len;

#endif  // TENSORFLOW_LITE_MODEL_CHUNK2_H_
