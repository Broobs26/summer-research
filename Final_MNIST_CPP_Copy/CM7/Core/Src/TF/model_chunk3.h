...
#ifndef TENSORFLOW_LITE_MODEL_CHUNK3_H_
#define TENSORFLOW_LITE_MODEL_CHUNK3_H_
...
extern const unsigned char model_chunk3[];
extern const int model_chunk3_len;

#endif  // TENSORFLOW_LITE_MODEL_CHUNK3_H_
