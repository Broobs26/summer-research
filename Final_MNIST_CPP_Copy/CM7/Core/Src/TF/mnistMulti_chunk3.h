...
#ifndef TENSORFLOW_LITE_MNIST_MULTI_CHUNK3_H_
#define TENSORFLOW_LITE_MNIST_MULTI_CHUNK3_H_
...
extern const unsigned char mnistMulti_chunk3[];
extern const int mnistMulti_chunk3_len;

#endif  // TENSORFLOW_LITE_MNIST_MULTI_CHUNK3_H_
