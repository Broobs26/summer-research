...
void classify_image(tflite::MicroInterpreter* interpreter, tflite::ErrorReporter* error_reporter, unsigned char *data) {
    ...
    //TfLiteTensor *output_mid_feature = interpreter->output(0); // Commented out by me
...
//	classify_image(names2.interpreter, names2.error_reporter, mnist_6_374);
	...
	//uint32_t predictions[NUM_TEST_SAMPLES]; // Commented out by me
	//uint32_t exits[NUM_TEST_SAMPLES]; // Commented out by me
	//float entropies[NUM_TEST_SAMPLES]; // Commented out by me
