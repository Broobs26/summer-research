...
#ifndef TENSORFLOW_LITE_MODEL_CHUNK1_H_
#define TENSORFLOW_LITE_MODEL_CHUNK1_H_
...
extern const unsigned char model_chunk1[];
extern const int model_chunk1_len;

#endif  // TENSORFLOW_LITE_MODEL_CHUNK1_H_
