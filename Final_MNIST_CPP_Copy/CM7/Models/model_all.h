...
#ifndef TENSORFLOW_LITE_MODEL_ALL_H_
#define TENSORFLOW_LITE_MODEL_ALL_H_

extern const unsigned char model_all[];
extern const int model_all_len;

#endif  // TENSORFLOW_LITE_MODEL_ALL_H_
