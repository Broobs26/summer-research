...
//#define STM32IPL_CAM_FB_ADDR                0xD0200000
...
#define STM32IPL_EXT_BUFFER_SIZE			(1024 * 512)	/* Size of the external memory buffer reserved to STM32IPL. */
#define STM32IPL_INT_BUFFER_SIZE			(1024 * 64)	/* Size of the internal memory buffer reserved to STM32IPL. */
