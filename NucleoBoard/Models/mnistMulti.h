...
#ifndef TENSORFLOW_LITE_MNIST_MULTI_H_
#define TENSORFLOW_LITE_MNIST_MULTI_H_

extern const unsigned char mnist_multi[];
extern const int mnist_multi_len;

#endif  // TENSORFLOW_LITE_MNIST_MULTI_H_
